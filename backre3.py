...
for f in sorted(images):
    ...
    # Numeric identifier of query image
    ...
    # Converts query image to chosen color space
    ...
    # Computes the mask thresholding every channel of chosen color space
